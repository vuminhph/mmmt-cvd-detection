...
#
#   python tuning_adaboost.py data model
#
...
from team_code_v3 import optimize_model
...
if __name__ == '__main__':
    ...
    optimize_model(data_folder, model_folder, verbose) ### Teams: Implement this function!!!
